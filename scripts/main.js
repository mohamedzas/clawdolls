...
'use strict'; {
    window.DOMElementHandler = class DOMElementHandler extends self.DOMHandler {
        ...
        _OnCreate(e) {
            ...
            elem.addEventListener("focus", e => this._OnFocus(elementId));
            elem.addEventListener("blur", e => this._OnBlur(elementId));
        ...
        _TestTransferablesWork() {
            ...
            messageChannel.port2.onmessage = e => {
                if (!e.data || !e.data["arrayBuffer"]) {
                    this._transferablesBroken = true;
...
'use strict'; {
    ...
    self.JobSchedulerDOM = class JobSchedulerDOM {
        constructor(runtimeInterface) {
            ...
            this._baseUrl = myUrl ? myUrl.substr(0, myUrl.lastIndexOf("/") + 1) : runtimeInterface.GetBaseURL();
...
'use strict'; {
    if (window["C3_IsSupported"]) {
        ...
        window["c3_runtimeInterface"] = new self.RuntimeInterface({
            useWorker: enableWorker && supportsWorker,
